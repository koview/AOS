...
class MyPageSettingFragment :
    BaseFragment<FragmentMypageSettingBinding>(R.layout.fragment_mypage_setting) {
    ...
    private fun NavController.toPoint() {
        val action =
            MyPageSettingFragmentDirections.actionMyPageSettingFragmentToSettingPointFragment()
        navigate(action)
    }

    private fun NavController.toLoginInfo() {
        val action =
            MyPageSettingFragmentDirections.actionMyPageSettingFragmentToSettingLoginInfoFragment()
        navigate(action)
    }

    private fun NavController.toOperating() {
        val action =
            MyPageSettingFragmentDirections.actionMyPageSettingFragmentToSettingOperatingFragment()
        navigate(action)
    }
}